...
public class NaverLoginBO {
	private final static String CLIENT_ID = "hg_EaXjXCIJ_6Xpo51lT";
	private final static String CLIENT_SECRET = "nq77R2T3Vq";
	private final static String REDIRECT_URI = "http://localhost:8080/board/callback";
